...
public class JMB_TC_018 {
    ...
    private void Tc18() throws InterruptedException {
        ...
        WebElement Element = driver.findElement(By.xpath("//h3[text()='ID Details ']"));
        // Scrolling down the page till the element is found
        js.executeScript("arguments[0].scrollIntoView();", Element);

        driver.findElement(By.xpath("(//a[@class='editBtn ajax-popup-mag'])[2]")).click();
        driver.findElement(By.xpath("//button[@type='submit']")).click();
        js.executeScript("arguments[0].scrollIntoView();", Element);
//        String yes = driver.findElement(By.xpath(""))
