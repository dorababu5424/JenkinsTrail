...
public class JMB_TC_009 {
    ...
    private  void  TC9(){
        ...
        String  profilcomplet = driver.findElement(By.xpath("//div[@class='jb-progrss-profile-completeness']")).getText();
        System.out.println(profilcomplet);
        Assert.assertEquals(profilcomplet,"Profile Completeness");
        String profilcompletePercent = driver.findElement(By.id("profileCompleteness")).getText();
        System.out.println(profilcompletePercent);
        Assert.assertEquals(profilcompletePercent,"59%");
    }
