...
public class JMB_TC_012 {
    ...
    public void TC12() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//a[@class='editBtn ajax-popup-mag openFromDirection']")).click();
        Thread.sleep(6000);

        String address =  driver.findElement(By.xpath("//input[@id='autocomplete']")).getText();
        System.out.println(address);
        driver.findElement(By.xpath("//button[@type='submit']")).click();

        String AddressDetails = driver.findElement(By.xpath("//div[@class='jb-address-text-sub']")).getText();
        System.out.println(AddressDetails);




        if (AddressDetails.contains("Canada")){
