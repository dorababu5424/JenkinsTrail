...
public class JMB_TC_010 {
    ...
    private void TC_010(){
        ...
        String  JSCOREtextVALIDATION = driver.findElement(By.xpath("//div[@class='jb-progrss-profile-score']")).getText();
        System.out.println(JSCOREtextVALIDATION);
        Assert.assertEquals(JSCOREtextVALIDATION,"JScore");
        String JSCOREPERCENTAGE = driver.findElement(By.id("jomboneScoreDiv")).getText();
        System.out.println(JSCOREPERCENTAGE);
        Assert.assertEquals(JSCOREPERCENTAGE,"348/900");
    }
    }
