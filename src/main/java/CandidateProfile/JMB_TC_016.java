...
public class JMB_TC_016 {
    ...
    private void Tc16() throws InterruptedException {
        ...
        WebElement Element = driver.findElement(By.xpath("(//a[@class='editBtn ajax-popup-mag'])[1]"));
        // Scrolling down the page till the element is found
        js.executeScript("arguments[0].scrollIntoView();", Element);

        driver.findElement(By.xpath("(//a[@class='jb-id-editBtn ajax-popup-mag'])[1]")).click();
        driver.findElement(By.xpath("(//div[text()='Select'])[1]")).click();
        driver.findElement(By.xpath("(//span[text()='Citizenship Card'])")).click();
