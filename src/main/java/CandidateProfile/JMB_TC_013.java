...
public class JMB_TC_013 {
    ...
    private void TC13() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@value='469 Activa Avenue, Kitchener, ON, Canada']")).clear();

        driver.findElement(By.xpath("//input[@class='form--control pac-target-input error']")).sendKeys("japan");
