...
public class JMB_TC_005 {
    ...
    private  void TC5() throws InterruptedException {
        ...
        WebElement HighestEducation = driver.findElement(By.xpath("//button[@class='btn dropdown-toggle btn-info']"));
        // Scrolling down the page till the element is found
        js.executeScript("arguments[0].scrollIntoView();", HighestEducation);

        HighestEducation.click();
        driver.findElement(By.xpath("//div[text()='University/Graduate']")).click();

        driver.findElement(By.xpath("//button[@type='submit']")).click();
        String validationHighestEduction = driver.findElement(By.xpath("//label[text()='University/Graduate']")).getText();
