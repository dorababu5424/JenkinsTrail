...
public class JMB_TC_015 {
    ...
    private void Tc15() throws InterruptedException {
        ...
        String errormsg = driver.findElement(By.xpath("//span[@class='help-block errorMsg']")).getText();

        Assert.assertEquals(errormsg,errormsg.contains("Please enter valid mobile number"));
